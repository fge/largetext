...
public final class TestCharsetDecoder
{
    ...
    {
        //final String input = "Mémé ça vient?";
        final String input = "Pousser Mémé dans les orties, ça se fait pas";
        final Charset charset = StandardCharsets.US_ASCII;
        final byte[] array = input.getBytes(charset);
        final ByteBuffer buf = ByteBuffer.allocate(array.length);
        buf.put(array);
